...
func (s *sendAccount) WithContext(ctx context.Context) *sendAccountDo {
	return s.sendAccountDo.WithContext(ctx)
}

func (s sendAccount) TableName() string { return s.sendAccountDo.TableName() }

func (s sendAccount) Alias() string { return s.sendAccountDo.Alias() }

func (s sendAccount) Columns(cols ...field.Expr) gen.Columns { return s.sendAccountDo.Columns(cols...) }
