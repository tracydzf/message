...
func newMessageTemplate(db *gorm.DB, opts ...gen.DOOption) messageTemplate {
	...
	_messageTemplate.FlowID = field.NewString(tableName, "flow_id")
	_messageTemplate.MsgStatus = field.NewInt32(tableName, "msg_status")
	_messageTemplate.CronTaskID = field.NewInt64(tableName, "cron_task_id")
	_messageTemplate.CronCrowdPath = field.NewString(tableName, "cron_crowd_path")
	_messageTemplate.ExpectPushTime = field.NewString(tableName, "expect_push_time")
...
type messageTemplate struct {
	...
	FlowID              field.String // 工单ID
	MsgStatus           field.Int32  // 当前消息状态：10.新建 20.停用 30.启用 40.等待发送 50.发送中 60.发送成功 70.发送失败
	CronTaskID          field.Int64  // 定时任务Id (xxl-job-admin返回)
	CronCrowdPath       field.String // 定时发送人群的文件路径
	ExpectPushTime      field.String // 期望发送时间：0:立即发送 定时任务以及周期任务:cron表达式
	...
	DeduplicationConfig field.String // 限流配置
...
func (m *messageTemplate) updateTableName(table string) *messageTemplate {
	...
	m.FlowID = field.NewString(table, "flow_id")
	m.MsgStatus = field.NewInt32(table, "msg_status")
	m.CronTaskID = field.NewInt64(table, "cron_task_id")
	m.CronCrowdPath = field.NewString(table, "cron_crowd_path")
	m.ExpectPushTime = field.NewString(table, "expect_push_time")
...
func (m *messageTemplate) fillFieldMap() {
	...
	m.fieldMap["flow_id"] = m.FlowID
	m.fieldMap["msg_status"] = m.MsgStatus
	m.fieldMap["cron_task_id"] = m.CronTaskID
	m.fieldMap["cron_crowd_path"] = m.CronCrowdPath
	m.fieldMap["expect_push_time"] = m.ExpectPushTime
